...
class Game(Window):#parent class Window is announced here.
    ...
    def data(self,username):
        ...
        cursor.execute('''SELECT Money,OwnResi1,ValueResi1 FROM Users WHERE Username = ? ''', (username,) ) #finds the correlating password to the username entered
    ...
    def game_function(self,username):
        ...
        data = self.data(username) # data will be all the data stored in the text file for the username used to login.
        r_total = 0
        owned_counter =0
        rent_rProp_1 = 0
        rent_rProp_2 = 0
